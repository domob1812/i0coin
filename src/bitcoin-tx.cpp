...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("I0coin Core i0coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  i0coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded i0coin transaction") + "\n" +
              "  i0coin-tx [options] -create [commands]   " + _("Create hex-encoded i0coin transaction") + "\n" +
              "\n";
